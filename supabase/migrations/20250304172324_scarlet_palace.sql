/*
  # Fix UUID issues with appointments table

  1. Changes
     - Change appointments table id column to text type instead of uuid
     - Add proper constraints to ensure data integrity
     - Update existing policies to work with the new structure
...
-- Create appointments table with text ID instead of UUID
